                  ...
                  return <div className="px-3 flex-none" style={{ width: 320 }} key={index}>
                          <div className="rounded-xl p-4 pb-8 relative bg-white">
                            <div className="rounded-xl overflow-hidden card-shadow w-full h-36">
                              <div className="bg-gray-300 animate-pulse rounded-lg w-full h-full overflow-hidden" style={{ width: 287, height: 150 }}></div>
                            </div>
...
export default function Details() {
  ...
  return (
    <>
      ...
      {
        isLoading ? <LoadingSuggestion /> : <Suggestions data={data.relatedProducts}/>
      }
      <Clients />
      <Sitemap />
      <Footer />
